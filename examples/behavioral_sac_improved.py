...
class Args:
    ...
    track: bool = True  # Changed from False to True
    """if toggled, this experiment will be tracked with Weights and Biases"""
    wandb_project_name: str = "RL_basic"  # Changed project name
    ...
    total_timesteps: int = 50000  # Reduced for quick experiment
    """total timesteps of the experiments"""
    num_envs: int = 8  # Use 8 environments to test parallelization
    ...
    log_frequency: int = 1000  # Reduced logging frequency
    """frequency of logging metrics"""
...
if __name__ == "__main__":
    ...
    # Initialize wandb first if tracking is enabled
    if args.track:
        import wandb
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            if global_step % args.log_frequency == 0:
                ...
                if episode_rewards:
                    metrics["performance/mean_episode_reward"] = np.mean(episode_rewards[-10:])  # Last 10 episodes
                ...
                print(f"SPS: {sps}, Step: {global_step}, Mean Reward (last 10): {np.mean(episode_rewards[-10:]) if episode_rewards else 'N/A'}")
